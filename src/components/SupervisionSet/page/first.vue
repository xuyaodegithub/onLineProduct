<template>
  <div class="seach-list" id="superFirst">
    <el-form ref="form" :model="form" label-width="80px">
      ...
      <!--  <editor id="editor_id" height="300px" width="500px" :content="editorText" :filterMode="false"
                uploadJson="http://test-admin.olquan.cn/doUploadWithWaterMarkToOss2?waterMark=defaultWaterMark"
                filePostName="imgFile"
                :fillDescAfterUploadImage="true"
                :afterUpload="filterImage"
       ...
       <el-form-item label="邀请内容:">
         <!--<editor id="editor_id2" height="300px" width="500px" :content="editorText2"
                 :afterChange="afterChange()"
                 pluginsPath="/static/kindeditor/plugins/"
                 :loadStyleMode="false"
  ...
  export default {
      ...
      upInfoListResult: {
        handler (newVal,oldVal) {
          ...
          // console.log(newVal.title+','+oldVal.title)
            this.isName=this.upInfoListResult.shareTitle
            this.isDesc=this.upInfoListResult.shareDesc
          this.infoForm.a_content=this.upInfoListResult.content
          this.infoForm.b_content=this.upInfoListResult.inviteContent
            this.dialogImageUrl=this.upInfoListResult.shareLogo
        },
        deep: true
      }
    },
    ...
    methods: {
      ...
      saveProduct() {
        ...
        if(this.upInfoListResult){
          data.id=this.upInfoListResult.id
        }
