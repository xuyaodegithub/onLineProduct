<template>
  <div id="newActive">
    <p><label>活动名称:</label><el-input v-model="input" placeholder="请输入活动名称" size="small"></el-input>
    ...
    <p><label>活动分享标题:</label><el-input v-model="input3" placeholder="请输入活动标题" size="small"></el-input>
      <span style="font-size: 12px;color: orange;margin-left: 10px;">（必填项）</span></p>
    <p><label style="vertical-align: top">活动分享描述:</label><el-input type="textarea" v-model="input1" placeholder="请输入活动描述" size="small" style="font-size: 12px;"></el-input>
      <span style="font-size: 12px;color: orange;margin-left: 10px;">（必填项）</span></p>
