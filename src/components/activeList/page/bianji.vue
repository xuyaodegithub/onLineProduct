    ...
    <div class="left">
      ...
      <div class="left-btn">
        ...
        <div v-for="(item,index) in addCommodityResult"  :class="{redborder : key===index}"  @click="otherSub(item,index)" class="cu" style="min-height: 40px;position: relative;">
          ...
          <div v-if="item.modelSampleCode=='productf5'" class="img" style="display: flex;">
            <div v-for="(itemSon,index) in item.contents" v-if="item.contents.length===2" style="width: 50%;">
              <img :src="itemSon.image" alt="">
            </div>
            <div v-for="(itemSon,index) in item.contents" v-if="item.contents.length===3" style="width: 33.3%;">
              <img :src="itemSon.image" alt="">
            </div>
          </div>
