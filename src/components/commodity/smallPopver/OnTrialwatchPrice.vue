        ...
        <el-table-column
          ...
          <template slot-scope="scope">
              <span style="margin-left: 10px" v-if="item.which=='salePrices'">
               <el-input placeholder="请输入..." class="GetPrice" v-model="BondMoney[scope.$index]" size="mini" style="width: 90%;" v-if="FreeUseProductNormalsResult.item.length>0"></el-input>
            ...
            <span style="margin-left: 10px" v-else-if="item.which=='normalStores'">
              <el-input placeholder="请输入..." class="Getnormal" v-model="priceListUpdata[scope.$index]" size="mini" style="width: 90%;" v-if="FreeUseProductNormalsResult.item.length>0"></el-input>
