  ...
  <div id="smalltitle">
    ...
    <p v-if="title=='SeachList'">
     ...
     <!-- <label>是否推荐:</label>&lt;!&ndash;<el-input v-model="GupGo" placeholder="请输入产品名称" size="mini"></el-input>&ndash;&gt;
      ...
      <label>特卖时间:</label>
      <el-date-picker type="date" placeholder="选择日期" v-model="date1" style="width:150px;" size="mini" value-format="yyyy-MM-dd"></el-date-picker>
...
'popoverAlive'
  ...
  components:{
    SeachList,NewSaleGoods,vPopover
  },
    mounted(){
