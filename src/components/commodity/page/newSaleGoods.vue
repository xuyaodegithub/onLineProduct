  ...
  <div class="seach-list" id="SaleNewone">
    ...
    <el-form ref="form" :model="form" label-width="80px">
         ...
         <el-table
           ...
           <el-table-column
             ...
             <span style="margin-left: 10px" v-if="item.which=='momey'">
               <el-input placeholder="请输入佣金" class="GetPrice" value="" size="mini" style="width: 90%;" v-if="getProductNormalsResult.length>0 && upDataSaleGoodsResult.type==='add'"></el-input>
               <el-input placeholder="请输入佣金"  v-model="priceListUpdata[scope.$index]" size="mini" style="width: 90%;" v-else-if="PproductgetByIdResult.item.length>0 && upDataSaleGoodsResult.type==='updata'"></el-input>
             ...
             <span style="margin-left: 10px" v-else-if="item.which=='salePriceView'">
               <el-input placeholder="请输入特卖价" class="activePrice" :value="salePriceViewPush[scope.$index]" size="mini" style="width: 90%;" v-if="getProductNormalsResult.length>0 && upDataSaleGoodsResult.type==='add'"></el-input>
               <el-input placeholder="请输入特卖价" v-model="activeUpdata[scope.$index]" value="" size="mini" style="width: 90%;" v-else-if="PproductgetByIdResult.item.length>0 && upDataSaleGoodsResult.type==='updata'"></el-input>
      ...
      <el-form-item label="特卖时间:">
        <el-col :span="11">
          <el-date-picker type="date" placeholder="选择日期" v-model="form.date" style="width:200px;" size="small"></el-date-picker>
        </el-col>
      </el-form-item>
      ...
      <el-form-item label="描述:">
        <el-input type="textarea" v-model="form.desc" style="width: 700px;" :maxlength="140" placeholder="最多140个字符"></el-input>
      </el-form-item>
       <el-form-item label="Tip:">
        <el-input type="textarea" v-model="form.trip" style="width: 700px;" :maxlength="70" placeholder="最多70个字符"></el-input>
      </el-form-item>
     <!-- <el-form-item label="是否推荐:">
      ...
      <el-form-item>
        <el-button type="primary" plain @click="saveProduct()" size="small" v-if="upDataSaleGoodsResult.type==='add'">立即添加</el-button>
  ...
  data () {
    return {
      ...
      form: {
        ...
        trip:'',
        namePrice:'',
        classArr:[{title:'规格',which:'normalStr',width:'300'},{title:'市场价',which:'marketPriceView',width:'130'},{title:'成本',which:'costPriceView',width:'130'},{title:'特卖价',which:'salePriceView',width:'130'},{title:'佣金',which:'momey',width:'130'}]
      },
