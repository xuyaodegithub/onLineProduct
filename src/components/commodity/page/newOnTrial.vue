      ...
      <el-form-item label="Tip:">
       ...
       <el-form-item label="产品信息:">
        ...
        <!--<el-button type="success" size="mini" round>选择产品</el-button>-->
         <el-table
           ...
           <el-table-column
             ...
             <span style="margin-left: 10px" v-if="item.which=='normalStores'">
               <el-input placeholder="请输入..."  :value="scope.row.store" class="GetnormalStores" size="mini" style="width: 90%;" v-if="getProductNormalsResult.length>0 && upDataSaleGoodsResult.type==='add'"></el-input>
               <el-input placeholder="请输入..."  v-model="priceListUpdata[scope.$index]" size="mini" style="width: 90%;" v-else-if="FreeUseProductNormalsResult.item.length>0 && upDataSaleGoodsResult.type==='updata'"></el-input>
               <el-input placeholder="请输入..." v-model="form.namePrice" size="mini" style="width: 90%;" :value="scope.row.store" v-else></el-input>
             </span>
             <span style="margin-left: 10px" v-else-if="item.which=='salePrices'">
               <el-input placeholder="请输入..." value="" class="GetsalePrices" size="mini" style="width: 90%;" v-if="getProductNormalsResult.length>0 && upDataSaleGoodsResult.type==='add'"></el-input>
               <el-input placeholder="请输入..." v-model="BondMoney[scope.$index]" size="mini" style="width: 90%;"  v-else-if="FreeUseProductNormalsResult.item.length>0 && upDataSaleGoodsResult.type==='updata'"></el-input>
         ...
         <p style="padding-left: 432px;" v-if="(getProductNormalsResult.length>0 && upDataSaleGoodsResult.type=='add') || (FreeUseProductNormalsResult.item.length>0 && upDataSaleGoodsResult.type=='updata')">
